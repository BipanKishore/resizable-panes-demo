  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={() => setJustUpdate(!justUpdate)}
      >setJustUpdate
      </button>
      <button
        className='btn btn-secondary btn-sm ms-1'
        onClick={() => ref.current.toFullSize('pane1')}
      >toFullSize
      </button>
      <button
        className='btn btn-secondary btn-sm ms-1'
        onClick={() => ref.current.closeFullSize()}
      >closeFullSize
      </button>
      <button
        className='btn btn-secondary btn-sm ms-1'
        onClick={() => ref.current.restoreDefault()}
      >restoreDefault
      </button>
      <button
        className='btn btn-secondary btn-sm ms-1'
        onClick={() => ref.current.toFullPage('pane1')}
      >toFullPage
      </button>
      <button
        className='btn btn-secondary btn-sm ms-1'
        onClick={() => ref.current.setVisibility({pane1: false, pane4: false})}
      >Hide Pane 1 & 4
      </button>
      <button
        className='btn btn-secondary btn-sm ms-1'
        onClick={() => ref.current.setVisibility({pane1: true, pane4: true})}
      >Show Pane 1 & 4
      </button>
      ...
      <button
        className='btn btn-secondary btn-sm ms-1' onClick={toggleSplit}
      >Buttoib
      </button> <b>{split}</b>
      <ResizerNode1 />
      <DefaultSizes
